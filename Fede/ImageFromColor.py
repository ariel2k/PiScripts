import cv2   
import numpy as np
import AdjustmentFromVectorModule
reload(AdjustmentFromVectorModule)
        ...
        while(1):
            ...
            for pic, contour in enumerate(contours):
                ...
                if(area>300):
                    ...
                    centersOfObjects.append([cx,cy])
                    cv2.circle(img, (cx, cy), 7, (255, 255, 255), -1) 
                    #adj = adjusmentfromvector.AdjustmentFromVector()
                    #adj.getAdjustmentFromCoor(x, y, w, h)

                if len(centersOfObjects)==2: #Si tengo mas de dos objetos en la escena
